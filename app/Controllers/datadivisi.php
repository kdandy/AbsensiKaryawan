...
class datadivisi extends BaseController
{
    public function index()
    {
        if(is_null(session()->get('logged_in'))){
            ...
            $divisi = $db->query("SELECT b.id_divisi, a.nik, a.username, 
            b.nama_divisi FROM divisi b, users a WHERE b.id_divisi = a.id_divisi")->getResult('array');
    ...
    Public function tambah( )
   {
        if(is_null(session()->get('logged_in'))){
            ...
            return view('pages/divisi/tambah', $data);
        }
    ...
    Public function prosestambah( )   
    {
        ...
        return view('pages\roles\tambah', [
            ...
            session()->setFlashdata('success', 'Tambah divisi berhasil');
    ...
    public function detail($id)
    {
        ...
        $divisi = $db->query("SELECT a.nik, a.username, b.nama_divisi, a.alamat, a.status_tinggal, 
        a.gol_darah, a.no_tlp, a.warga, a.agama, a.ktp, 
        a.npwp FROM users a, 
        divisi b WHERE a.id_divisi = 
        b.id_divisi AND a.id_users = '$id'")->getResult('array');

        $data = [
            'divisi' => $divisi
        ];

        return view('pages/divisi/detail', $data);
    }
    ...
    public function prosesEdit($id)
    {
        ...
        if(!$validator){
            ...
            session()->setFlashdata('success', 'Edit divisi berhasil');
            return redirect()->to('/divisi');
        }
